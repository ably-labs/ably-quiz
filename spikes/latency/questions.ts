...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: ['Live presence state', 'Past message history and rewind', 'Billing records', 'Connection logs'],
    answer: 'B',
    timeLimitS: 20,
  },
  ...
  // ---- Band 3: Ably-internal-flavoured (grounding-sensitive) ----
  {
    ...
    options: ['Ably Internal Tooling', 'AI Transport', 'Async Integration Tier', 'Adaptive Ingest Topology'],
    answer: 'B',
    timeLimitS: 20,
  },
  {
